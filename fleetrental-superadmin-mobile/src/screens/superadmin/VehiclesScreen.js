...
const STATUS_CONFIG = {
    ...
    reserved:       { label: 'Réservée',     color: ACCENT,    bg: '#f5f3ff', icon: 'bookmark' },
};
...
export default function VehiclesScreen() {
    ...
    const FILTERS = [
        { value: 'all',            label: 'Tous',         icon: 'car-sport',        color: PRIMARY, bg: '#f5f3ff', count: vehicles.length },
    ...
    return (
        <SafeAreaView style={styles.safe}>
            ...
            <FlatList
                ...
                refreshControl={
                    <RefreshControl refreshing={refreshing} onRefresh={() => loadVehicles(true)} colors={[ACCENT]} />
                }
                ListEmptyComponent={
...
const styles = StyleSheet.create({
    ...
    letterBtnActive: { backgroundColor: PRIMARY },
    letterText:      { fontSize: 18, color: '#475569' },
    letterTextActive:{ color: '#fff' },
    platePreview: {
        marginTop: 8, fontSize: 14, fontWeight: '700', color: PRIMARY,
