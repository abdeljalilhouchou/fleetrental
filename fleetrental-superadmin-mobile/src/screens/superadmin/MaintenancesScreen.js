...
export default function MaintenancesScreen() {
    ...
    const FILTERS = [
        { value: 'all',         label: 'Toutes',     icon: 'list',             color: PRIMARY, bg: '#f5f3ff', count: maintenances.length },
              ...
              {showVehiclePicker ? (
                <SafeAreaView style={styles.modalSafe}>
                    ...
                    <FlatList
                        ...
                        renderItem={({ item: v }) => {
                            const statusColors = { available: '#16a34a', rented: '#2563eb', maintenance: '#d97706', out_of_service: '#dc2626', reserved: ACCENT };
                            const statusLabels = { available: 'Disponible', rented: 'Louée', maintenance: 'En maintenance', out_of_service: 'Hors service', reserved: 'Réservée' };
                            return (
                                <TouchableOpacity
                        ...
                        <ScrollView style={styles.modalBody} keyboardShouldPersistTaps="handled">
                            ...
                            <View style={styles.row2}>
                                <View style={[styles.fieldWrap, { flex: 1 }]}>
                                    ...
                                    >
                                        <Ionicons name="calendar-outline" size={16} color={form.date ? PRIMARY : '#94a3b8'} />
