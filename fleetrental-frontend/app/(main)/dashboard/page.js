...
export default function DashboardPage() {
    ...
    const stats = [
        { title: 'Véhicules Total', value: vehicles.length,                                          icon: Car,            iconColor: 'text-blue-600 dark:text-blue-400',   iconBg: 'bg-blue-50 dark:bg-blue-900/30' },
        { title: 'Disponibles',     value: vehicles.filter(v => v.status === 'available').length,    icon: CheckCircle2,   iconColor: 'text-green-600 dark:text-green-400',  iconBg: 'bg-green-50 dark:bg-green-900/30' },
        { title: 'En Location',     value: vehicles.filter(v => v.status === 'rented').length,       icon: Clock,          iconColor: 'text-orange-600 dark:text-orange-400', iconBg: 'bg-orange-50 dark:bg-orange-900/30' },
        { title: 'Maintenance',     value: vehicles.filter(v => v.status === 'maintenance').length,  icon: Wrench,         iconColor: 'text-purple-600 dark:text-purple-400', iconBg: 'bg-purple-50 dark:bg-purple-900/30' },
    ];
        ...
        <div>
            ...
            <div className="grid grid-cols-4 gap-5 mb-8">
                {stats.map((stat, i) => {
                    ...
                    return (
                        <div key={i} className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-5 hover:shadow-md transition">
                            <div className="mb-4">
            ...
            <div className="grid grid-cols-3 gap-5">
                ...
                <div className="col-span-2 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-6">
                    <div className="flex items-center justify-between mb-5">
                        <h2 className="font-bold text-gray-800 dark:text-gray-100">Véhicules récents</h2>
                    ...
                    {vehicles.length === 0 ? (
                        <div className="text-center py-10">
                            ...
                            <p className="text-gray-400 dark:text-gray-500 text-sm">Aucun véhicule pour le moment</p>
                        </div>
                    ) : (
