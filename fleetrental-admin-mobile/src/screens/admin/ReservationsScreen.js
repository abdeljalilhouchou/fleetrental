    ...
    return (
        <SafeAreaView style={styles.safe}>
            ...
            <View style={styles.filterRow}>
                {[
                    { key: 'all',       label: 'Toutes',      color: '#1e3a5f' },
...
const styles = StyleSheet.create({
    ...
    rejectBtn: {
        ...
        borderWidth: 1.5, borderColor: '#dc2626', borderRadius: 10, paddingVertical: 10,
    },
    rejectBtnText: { color: '#dc2626', fontWeight: '700', fontSize: 13 },
    confirmBtn: {
        flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5,
        backgroundColor: '#16a34a', borderRadius: 10, paddingVertical: 10,
    },
