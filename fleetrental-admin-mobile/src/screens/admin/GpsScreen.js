...
export default function GpsScreen() {
    ...
    const renderItem = ({ item: loc }) => {
        ...
        const vehicleLabel = loc.vehicle
            ...
            : (loc.vehicle_label || '—');
        const plate = loc.vehicle?.immatriculation || loc.plate || null;
    ...
    return (
        <SafeAreaView style={styles.safe}>
            ...
            <View style={styles.summaryBar}>
                ...
                <View style={styles.summaryDivider} />
                <View style={styles.summaryItem}>
                    <Ionicons name="car-sport-outline" size={14} color="#1e3a5f" />
...
const styles = StyleSheet.create({
    ...
    refreshNote: {
        ...
        gap: 5, paddingVertical: 8, backgroundColor: '#f8fafc',
    },
